...
public class CarRentalAPIService : ICarRentalAPIService
{
    ...
    {
        string path = "api/RentService/GetAllVehiclesAsync";
    ...
    {
        string path = "api/RentService/GetAllElectricVehiclesAsync";
        HttpResponseMessage response = _httpClient.GetAsync(path).Result;
        if (response.IsSuccessStatusCode)
        {
            string jsonResponse = response.Content.ReadAsStringAsync().Result;
    ...
    {
        string path = "api/RentService/GetAllFossilFuelVehiclesAsync";
        HttpResponseMessage response = _httpClient.GetAsync(path).Result;
        if (response.IsSuccessStatusCode)
        {
            string jsonResponse = response.Content.ReadAsStringAsync().Result;
    ...
    {
        string path = "api/RentService/GetAllClientsAsync";
        HttpResponseMessage response = _httpClient.GetAsync(path).Result;
        if (response.IsSuccessStatusCode)
        {
            string jsonResponse = response.Content.ReadAsStringAsync().Result;
    ...
    {
        string path = "api/RentService/GetAllRentsAsync";
        HttpResponseMessage response = _httpClient.GetAsync(path).Result;
        if (response.IsSuccessStatusCode)
        {
            string jsonResponse = response.Content.ReadAsStringAsync().Result;
